...
CHALLENGES += [
    ...
    {"prompt": "Send a nude close-up photo of just your nipples", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude close-up photo of your genitals, no other context in the shot", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo touching your genitals, mid-motion", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo of just your ass, taken from directly behind", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo of your inner thigh, high up, close to your genitals", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo of your ass with your own hand on it", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo taken from directly above, looking down at yourself", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo taken from below, looking up", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo taken in the mirror from across the room, full body nude", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo taken over your shoulder, looking back at the camera", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a nude photo from directly side-on, completly nude", "category": "longdistance", "requires_both": False},
    {"prompt": "Send five photos in a row, each one a closer crop than the last", "category": "longdistance", "requires_both": False},
    {"prompt": "Send two photos - one fully dressed, one seconds later with all clothing removed", "category": "longdistance", "requires_both": False},
    {"prompt": "Send four nude photos - front, back, and both sides", "category": "longdistance", "requires_both": False},
    {"prompt": "Send three nude photos of the exact same pose from three different angles", "category": "longdistance", "requires_both": False},
    {"prompt": "Send two close-up photos of your genitals, one from a different angle than the first", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a close-up photo of your nipples, taken from directly above", "category": "longdistance", "requires_both": False},
