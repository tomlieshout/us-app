...
CHALLENGES += [
    {"prompt": "Both - Send your partner one explicit photo", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a mirror selfie in exactly what you're wearing right now, however that looks", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send three photos back to back, each one going further than the last", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Ask your partner to name a body part over text, then send a photo of just that", "category": "longdistance", "requires_both": True},
    {"prompt": "Aish - Send a nude close-up photo of just your nipples", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude close-up photo of your genitals, no other context in the shot", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo touching your genitals, mid-motion", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send a nude photo of just your ass, taken from directly behind", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo of your inner thigh, high up, with your genitals in view", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send a nude photo of your ass with your own hand on it", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo taken from directly above, looking down at yourself", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo taken from below, looking up", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo taken in the mirror from across the room, full body nude", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send a nude photo taken over your shoulder, looking back at the camera", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send a nude photo from directly side-on, completly nude", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send five photos in a row, each one a closer crop than the last", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send two photos - one fully dressed, one seconds later with all clothing removed", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send four nude photos - front, back, and both sides", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send three nude photos of the exact same pose from three different angles", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Send two close-up photos of your genitals, one from a different angle than the first", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send a close-up photo of your nipples, taken from directly above", "category": "longdistance", "requires_both": False},
    {"prompt": "Aish - Send a photo of your ass taken from below, like you're being looked up at", "category": "longdistance", "requires_both": False},
    {"prompt": "Both - Ask your partner to pick a number from 1 to 5, then send exactly that many photos", "category": "longdistance", "requires_both": True},
    {"prompt": "Both - Tell your partner exactly when to expect a photo today, then actually send it right on time", "category": "longdistance", "requires_both": False},
    {"prompt": "Tom - Set a timer and masturbate for exactly 10 minutes without finishing, then text your partner when the timer's up", "category": "longdistance", "requires_both": False},
    {"prompt": "Tom - Edge yourself three times over the course of an hour to your partners nudes", "category": "longdistance", "requires_both": False},
    {"prompt": "Tom - Masturbate to your partners nudes thinking about one specific memory, then tell your partner", "category": "longdistance", "requires_both": False},
    {"prompt": "Tom - Masturbate at a specific time your partner picks earlier in the day, then confirm by text afterward", "category": "longdistance", "requires_both": True},
]
