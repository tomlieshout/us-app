...
CHALLENGES += [
    ...
    {"prompt": "Send a close-up photo of just your nipples", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a close-up photo of your genitals, no other context in the shot", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo touching your genitals, mid-motion", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo of just your ass, taken from directly behind", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo of your inner thigh, high up, close to your genitals", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo of your ass with your own hand on it", "category": "longdistance", "requires_both": False},
    ...
    {"prompt": "Send a photo taken in the mirror from across the room, full body nude", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo taken over your shoulder, looking back at the camera", "category": "longdistance", "requires_both": False},
    {"prompt": "Send a photo from directly side-on, completly nude", "category": "longdistance", "requires_both": False},
    ...
    {"prompt": "Send a photo of your genitals, and describe over text exactly what you wish was happening to them right now", "category": "longdistance", "requires_both": False},
    ...
    {"prompt": "Masturbate thinking about one specific memory, then tell your partner", "category": "longdistance", "requires_both": False},
